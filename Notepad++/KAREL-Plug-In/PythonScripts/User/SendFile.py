...
#Date : 14.09.2016
#Changed : Willi Sengmueller
##########################################
# 03.03.2017 Changed Path from ListFlile for Robot.dat to SVN Directory
##########################################
from Tkinter import *
import ttk
from ftplib import *
...
ListFlile = os.path.dirname(os.path.realpath(__file__))
Pathparts = ListFlile.split("\\")
ListFlile = "\\".join(Pathparts[0:-1]) + "\\User\\Robot.dat"
####################################
Robotlines = ()
####################################
#Message box	
